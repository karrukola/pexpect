...
The main features of Pexpect require a pseudo-terminal. Unix-like systems have
one in the standard library, and ``pexpect.spawn`` also works on Windows 10 and
11, through ConPTY by way of ``pywinpty``. There,
