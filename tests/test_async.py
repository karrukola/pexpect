...
class AsyncTests(pexpect_test_case.AsyncPexpectTestCase):
    ...
    async def test_simple_expect(self) -> None:
        ...
        with pexpect.spawn(commands.CAT) as p:
    ...
    async def test_timeout(self) -> None:
        ...
        with pexpect.spawn(commands.CAT) as p, pytest.raises(pexpect.TIMEOUT):
    ...
    async def test_async_and_sync(self) -> None:
        ...
        with pexpect.spawn(commands.echo("1234"), encoding="utf8", maxread=1) as p:
